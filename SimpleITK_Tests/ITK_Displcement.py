...
######INITIAL TRANSFORM##############
initialTx = itk.CenteredTransformInitializer(fixedImage, movingImage, itk.AffineTransform(fixedImage.GetDimension()))

######SET PARAMETERS FOR REGISTRATION######

# TransformType = itk.TranslationTransform[itk.D, 2]
# TransformType = itk.DisplacementFieldTransform[itk.D, 2]
...
imageMetric = itk.MutualInformationImageToImageMetric[FixedImageType, MovingImageType].New()
